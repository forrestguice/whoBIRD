...
This is a forked version that contains modifications © Forrest Guice.
This soft-fork was created for personal use; I will not be providing tagged releases or user support.

Please give your support to the [upstream project](https://github.com/woheller69/whoBIRD).
